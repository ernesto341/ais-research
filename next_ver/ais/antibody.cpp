...
int Antibody::match(int *test)
{
	...
	/* HERE - return normal traffic by default in order to force the training to generate realistic values in antibodies */
	return (0);

	/* previous operation - return unknown attack */
	return (1);
}
